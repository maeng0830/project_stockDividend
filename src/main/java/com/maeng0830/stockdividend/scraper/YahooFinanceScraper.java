...
import com.maeng0830.stockdividend.model.constants.Month;
    ...
    public ScrapedResult scrap(Company company) {
        ...
        try {
            ...
            Elements parsingDivs = document.getElementsByAttributeValue("data-test",
                "historical-prices");
            Element tableEle = parsingDivs.get(0); // table 태그 전체

            Element tbody = tableEle.children().get(1); // table 내부의 tbody
